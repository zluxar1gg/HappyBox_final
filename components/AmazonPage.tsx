...
export const AmazonPage: React.FC<AmazonPageProps> = ({ language, setLanguage, onBack }) => {
    ...
    const content = {
        en: {
            ...
            subtitle: <>Scale your Amazon business with HappyBox. We provide end-to-end logistics from your Chinese factory directly to Amazon Fulfillment Centers in the USA and Europe (EU). No minimum weight requirement — we ship from <span className="bg-brand-yellow px-1.5 py-0.5 rounded text-brand-dark font-bold whitespace-nowrap">0.1 kg</span>.</>,
        ...
        ru: {
            ...
            subtitle: <>Масштабируйте бизнес на Amazon с HappyBox. Мы обеспечиваем логистику полного цикла от фабрики в Китае до складов Amazon FBA в США и Европе. Нет минимального веса — доставляем от <span className="bg-brand-yellow px-1.5 py-0.5 rounded text-brand-dark font-bold whitespace-nowrap">0.1 кг</span>.</>,
