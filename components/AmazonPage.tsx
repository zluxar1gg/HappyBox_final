...
export const AmazonPage: React.FC<AmazonPageProps> = ({ language, setLanguage, onBack, onNavigate }) => {
    ...
    const content = {
        en: {
            ...
            titlePrefix: "Amazon FBA Prep Center in China",
            titleHighlight: "",
            titleSuffix: "",
        ...
        ru: {
            ...
            titlePrefix: "Фулфилмент и преп-центр Amazon FBA в Китае",
            titleHighlight: "",
            titleSuffix: "",
                    ...
                    <div className="container mx-auto px-6 xl:px-0">
                         <div className="max-w-5xl mx-auto text-center">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-[1.1] text-brand-dark mb-8 tracking-tight">
                                {t.titlePrefix} {t.titleHighlight && <span className="text-orange-500 relative inline-block">
                                    {t.titleHighlight}
                                ...
                                {t.titleSuffix && <><br />{t.titleSuffix.replace(/^:\s*/, '')}</>}
                            </h1>
